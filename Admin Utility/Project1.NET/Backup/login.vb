...
#End Region 
	Private Sub Command1_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles Command1.Click
		...
		Else
            ...
            Form1.DefInstance.RS.Open("select * from owner where owner_id='" & Text1.Text & "' and pwd='" & Text2.Text & "'", Form1.DefInstance.OBJ, ADODB.CursorTypeEnum.adOpenDynamic)
	...
	Private Sub Form14_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
        Form1.DefInstance.OBJ.Open(("FILE NAME=F:\My Development\Online Jewelry Shop\Admin Utility\Project1.NET\obj\Debug\Data link.udl"))
	End Sub
End Class