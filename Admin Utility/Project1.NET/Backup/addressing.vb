...
#Region "Windows Form Designer generated code "
	...
	<System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
		...
		Me.Text3.Location = New System.Drawing.Point(160, 48)
		...
		Me.Command2.Location = New System.Drawing.Point(232, 296)
		...
		Me.Command1.Location = New System.Drawing.Point(56, 296)
		...
		Me.Text2.Location = New System.Drawing.Point(160, 232)
		Me.Text2.TabIndex = 3
		...
		Me.Text1.Size = New System.Drawing.Size(217, 105)
		Me.Text1.Location = New System.Drawing.Point(160, 104)
		...
		Me.Label2.Location = New System.Drawing.Point(96, 232)
...
#Region "Upgrade Support "
	Private Shared m_vb6FormDefInstance As Form18
	Private Shared m_InitializingDefInstance As Boolean
	Public Shared Property DefInstance() As Form18
		Get
			If m_vb6FormDefInstance Is Nothing OrElse m_vb6FormDefInstance.IsDisposed Then
				m_InitializingDefInstance = True
				m_vb6FormDefInstance = New Form18()
...
#End Region 
	Private Sub Command1_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles Command1.Click
		...
		If Text1.Text = "" And Text2.Text = "" And Text3.Text = "" Then
			MsgBox("First Fill up the Fields", MsgBoxStyle.OKOnly, "PROMPT")
		Else
			
			Form1.DefInstance.RS.Open("Select * from owner where pwd='" & Text3.Text & "'", Form1.DefInstance.OBJ, ADODB.CursorTypeEnum.adOpenDynamic)
			
			If Form1.DefInstance.RS.EOF Then
				MsgBox("Incorrect Password", MsgBoxStyle.OKOnly, "PROMPT")
				Form1.DefInstance.RS.Close()
			Else
				'UPGRADE_WARNING: Couldn't resolve default property of object o. Click for more: 'ms-help://MS.VSCC/commoner/redir/redirect.htm?keyword="vbup1037"'
				o = Form1.DefInstance.RS.Fields("owner_id").Value
				p = Form1.DefInstance.RS.Fields("pwd").Value
				i = Form1.DefInstance.RS.Fields("total_items").Value
				
				Form1.DefInstance.RS.Close()
				
				Form1.DefInstance.OBJ.Execute("Delete * from owner")
				'UPGRADE_WARNING: Couldn't resolve default property of object o. Click for more: 'ms-help://MS.VSCC/commoner/redir/redirect.htm?keyword="vbup1037"'
				Form1.DefInstance.OBJ.Execute("insert into owner values('" & o & "','" & p & "','" & i & "' ,'" & Text1.Text & "','" & Text2.Text & "') ")
				
				MsgBox("Addressing/Email Changed", MsgBoxStyle.OKOnly, "PROMPT")
			End If
