...
#Region "Windows Form Designer generated code "
	...
	<System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
		...
		Me.Check1.Text = "Accept Order, order status changes to ""IN-PROCESS""mode"
		Me.Check1.Size = New System.Drawing.Size(313, 17)
		Me.Check1.Location = New System.Drawing.Point(24, 160)
		Me.Check1.TabIndex = 31
...
#Region "Upgrade Support "
	Private Shared m_vb6FormDefInstance As Form9
	Private Shared m_InitializingDefInstance As Boolean
	Public Shared Property DefInstance() As Form9
		Get
			If m_vb6FormDefInstance Is Nothing OrElse m_vb6FormDefInstance.IsDisposed Then
				m_InitializingDefInstance = True
				m_vb6FormDefInstance = New Form9()
...
#End Region 
	...
	Private Sub Command3_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles Command3.Click
		...
		'UPGRADE_WARNING: Couldn't resolve default property of object num. Click for more: 'ms-help://MS.VSCC/commoner/redir/redirect.htm?keyword="vbup1037"'
		num = Val(Text7.Text)
		
		state = "Just-Received"
		
		'UPGRADE_WARNING: Couldn't resolve default property of object num. Click for more: 'ms-help://MS.VSCC/commoner/redir/redirect.htm?keyword="vbup1037"'
		Form1.DefInstance.RS.Open("select * from order_info where number > '" & num & "' and status = '" & state & "' ", Form1.DefInstance.OBJ, ADODB.CursorTypeEnum.adOpenDynamic)
		...
		Else
			...
			'Text11.Text = Form1.RS.Fields("status")
