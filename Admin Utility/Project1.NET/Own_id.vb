...
#Region "Windows Form Designer generated code "
	...
	<System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
		...
		Me.Command2.Location = New System.Drawing.Point(176, 192)
		...
		Me.Command1.Location = New System.Drawing.Point(32, 192)
		...
		Me.Text3.Location = New System.Drawing.Point(104, 120)
		Me.Text3.TabIndex = 5
		...
		Me.Text2.Location = New System.Drawing.Point(104, 72)
...
#Region "Upgrade Support "
	Private Shared m_vb6FormDefInstance As Form17
	Private Shared m_InitializingDefInstance As Boolean
	Public Shared Property DefInstance() As Form17
		Get
			If m_vb6FormDefInstance Is Nothing OrElse m_vb6FormDefInstance.IsDisposed Then
				m_InitializingDefInstance = True
				m_vb6FormDefInstance = New Form17()
...
#End Region 
	Private Sub Command1_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles Command1.Click
		...
		Else
			...
			'MsgBox "New Passwords does not match", vbOKOnly, "PROMPT"
			'Else
			'MsgBox "New Passwords match", vbOKOnly, "PROMPT"
			Form1.DefInstance.RS.Open("Select owner_id from owner where pwd='" & Text2.Text & "' and owner_id='" & Text1.Text & "' ", Form1.DefInstance.OBJ, ADODB.CursorTypeEnum.adOpenDynamic)
			...
			Else
				Form1.DefInstance.RS.Close()
				Form1.DefInstance.OBJ.Execute("update owner set owner_id = '" & Text3.Text & "' ")
				MsgBox("ID Changed", MsgBoxStyle.OKOnly, "PROMPT")
			End If
